        ...
        <div  className="flex flex-col gap-5">
          <Card>
            <div className="flex items-center py-0">
              <CgProfile className="mr-4 text-[2rem] bg-primary text-white p-1 rounded-full" />
          ...
          <Card>
            <div className="flex items-center">
              <HiUsers className="mr-4 text-[2rem] bg-primary text-white p-1 rounded-full"/>
              <div className="flex flex-col leading-tight">
          ...
          <Card>
            <div className="flex items-center">
              ...
              <div className="flex flex-col leading-tight">
                <span className=" font-medium text-[1.2rem]">% Onboarding</span>
                <span className="text-primary font-semibold text-[2rem]">
                  {onBording} %
                </span>
              </div>
          ...
          <Card>
            <div className="flex items-center">
              ...
              <div className="flex flex-col leading-tight">
                <span className=" font-medium text-[1.2rem]">% Actifs</span>
                <span className="text-primary font-semibold text-[2rem]">
                  {activeUsers} %
                </span>
              </div>
