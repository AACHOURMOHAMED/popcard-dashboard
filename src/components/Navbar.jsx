...
const Navbar = () => {
  return (
    <div className="fixed top-0 left-0 bg-white w-[11rem] h-[100vh] pt-[4rem] pl-[1rem]">
      ...
      <div>
        <ul className="flex flex-col">
          ...
          <NavLink to="/" className="flex items-center mb-5">
            <HiUsers className="mr-3 text-secondary" />
            <span className="active:text-primary text-secondary font-semibold">
              Utilisateurs
            </span>
          </NavLink>
          <NavLink to="/" className="flex items-center mb-5">
            <HiStatusOnline className="mr-3 text-secondary" />
            <span className="active:text-primary text-secondary font-semibold">
              Live Stats
            </span>
          </NavLink>
          <NavLink to="/" className="flex items-center mb-5">
            <RiUserSettingsFill className="mr-3 text-secondary" />
            <span className="active:text-primary text-secondary font-semibold">
              {" "}
              Gestionnaires
            </span>
          ...
          <NavLink to="/" className="flex items-center">
            <FaShoppingCart className="mr-3 text-secondary" />
            <span className="active:text-primary text-secondary font-semibold">
              Commandes
            </span>
          </NavLink>
